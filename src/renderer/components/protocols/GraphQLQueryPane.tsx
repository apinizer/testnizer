      ...
      <div className="flex shrink-0 items-center gap-2 border-b border-[var(--border)] px-3.5 py-2">
        ...
        {isSubscription ? (
          <button
            ...
            className="flex shrink-0 cursor-pointer items-center gap-1.5 rounded-lg px-3.5 py-2 text-sm font-medium text-white transition-opacity disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <button
          ...
          className="flex shrink-0 cursor-pointer items-center gap-1.5 rounded-lg border border-[var(--border)] px-3 py-2 text-sm font-medium text-[var(--text)] transition-colors hover:bg-[var(--surface)] disabled:cursor-not-allowed disabled:opacity-50"
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="shrink-0 border-t border-[var(--border)]">
          <button
            ...
            className="flex w-full cursor-pointer items-center gap-2 px-3.5 py-2 text-left text-sm font-medium text-[var(--text)] transition-colors hover:bg-[var(--surface)]"
