      ...
      <div className="flex w-[45%] flex-col overflow-auto bg-[var(--white)]">
        <div className="flex-1 overflow-auto px-5 py-4">
              ...
              <div className="space-y-2.5">
                <Checkbox label="Persist responses for a session" checked={persistResponses} onChange={setPersistResponses} />
                <Checkbox label="Stop run if an error occurs" checked={stopOnError} onChange={setStopOnError} />
                <Checkbox label="Keep variable values" checked={keepVariableValues} onChange={setKeepVariableValues} />
                <Checkbox label="Save cookies after collection run" checked={saveCookies} onChange={setSaveCookies} />
              </div>
